...
def Init_Singal(self: "MyMAinWindow"):
    ...
    self.Ui.pushButton_test_javstash.clicked.connect(self.pushButton_test_javstash_clicked)
    ...
    self.set_javstash_status.connect(self.Ui.label_javstash_test_result.setText)
